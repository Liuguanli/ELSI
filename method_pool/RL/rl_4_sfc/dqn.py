...
class DeepQNetwork():
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            e1 = tf.layers.dense(self.s, self.width, tf.nn.relu, kernel_initializer=w_initializer,
        ...
        with tf.variable_scope('target_net'):
            t1 = tf.layers.dense(self.s_, self.width, tf.nn.relu, kernel_initializer=w_initializer,
